...
const InfoModal: React.FC<InfoModalProps> = ({
    ...
    return(
        <div className="z-50 transition duration-500 bg-black bg-opacity-80 flex 
            ...
            <div className="relative w-auto mx-auto max-w-3xl rounded-md overflow-hidden">
                ...
                `}>
                    <div className="relative h-96">
                        ...
                        className="cursor-pointer absolute top-3 right-3 h-10 w-10 rounded-full 
                        bg-black bg-opacity-70 justify-center flex items-center">
