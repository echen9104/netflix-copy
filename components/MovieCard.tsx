...
const MovieCard: React.FC<MovieCardProps> = ({
    ...
    return (
        <div className="group bg-zinc-900 col-span relative h-[12vw]">
            <img className="cursor-pointer object-cover transition duration shadow-xl rounded-md group-hover:opacity-90 sm:group-hover:opacity-0 delay-200 w-full h-[12vw]"
            ...
            group-hover:translate-x-[2vw] group-hover:opacity-100">
                ...
                <div className="z-10 bg-zinc-800 p-2 lg:p-4 absolute w-full transition shadow-md rounded-b-md">
                    <div className="flex flex-row items-center gap-3">
                        <div className="cursor-pointer w-6 h-6 lg:h-10 lg:w-10 bg-white rounded-full flex items-center justify-center transition
                        ...
                        className="cursor-pointer ml-auto groupitem w-6 h-6 lg:w-10 lg:h-10 border-white border-2 
